function [labels] = enforceMinDuration_X(labels, limits, enforceInOrder, setUndef)
% enforceMinDuration_X Remove sleep stage bouts that are shorter than a threshold
% Zeke Barger 021321
